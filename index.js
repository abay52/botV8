...
const VhtearKey = 'AHMAD PRASETYO' 
...
/******** OWNER NUMBER**********/
const ownerNumber = ["6287869984953@s.whatsapp.net","@s.whatsapp.net"] 

const mod = [ownerNumber,"6287869984953@s.whatsapp.net","6287869984953@s.whatsapp.net"]

const adminbotnumber = ["6287869984953@s.whatsapp.net","6287869984953@s.whatsapp.net"]

const frendsowner = ["6287869984953@s.whatsapp.net","6287869984953@s.whatsapp.net"]

const premium = ["6287869984953@s.whatsapp.net","6287869984953@s.whatsapp.net"]

const donator = ["6287869984953@s.whatsapp.net","6287869984953@s.whatsapp.net"]
/************************************/
...
const client = new WAConnection()
   ...
   console.log(color('🍁','white'),color('♥','red'),color('🍁','white'),color('JANGAN LUPA SUBS CHANEL','white'),color('YOU','red'),color('TUBE','white'),color('AMINAH BOTZ','yellow'))
})
...
if (bad.includes(messagesC)){
	...
	// ANTI LINK GRUP
		        ...
		        setTimeout( () => {
			        client.groupRemove(from, [kic]).catch((e)=>{reply(`*AMINAH  HARUS JADI ADMIN❗*`)})
		        }, 3000)
		        setTimeout( () => {
			        client.updatePresence(from, Presence.composing)
			        reply("Hedsot....")
...
reply('assalamualaikum kak\nAda Yang Bisa Aminah Bantu?')
}
if (budy.includes(`P`)) {
reply('Alangkah Baiknya Menggunakan Salam 🙏🏻😇')
}
...
85. Oʀᴇ ɴᴏ Iᴍᴏᴜᴛᴏ ɢᴀ Kᴏɴɴᴀɴɪ Kᴀᴡᴀɪɪ Wᴀᴋᴇ ɢᴀ Nᴀɪ`, text, tescuk, cr)
		...
		client.sendMessage(from, buffer, image, {quoted: mek, caption: infomp3})
                ...
                break
                case 'play':
                if (!isDonator) return reply(mess.only.donator)
...
if (!isPublic) return reply(mess.only.publikG)
                ...
                if (umurUser > 20) return reply(`*UMUR KAMU TERLALU TUA UNTUK MENJADI TEMAN AMINAH *`)
